...
> Your mission is to enter Dr. Evil's laboratory and retrieve the blueprints for his Doomsday Project. The laboratory is protected by a series of locked vault doors. Each door is controlled by a c[...]
...
Đây là lỗi thực tế gặp nhiều trong code production — developer hardcode credential vào source rồi push lên GitHub public. Trong Blue Team, công cụ như **truffleHog** hoặc [...]

**2. Đọc kỹ toàn bộ flow, không chỉ hàm kiểm tra**

Bài này có bẫy nhỏ ở bước xử lý input trước `checkPassword`. Nếu chỉ đọc hàm `checkPassword` mà bỏ qua `substring`, sẽ nhập sai và bị Access denied. Trong RE, [...]
